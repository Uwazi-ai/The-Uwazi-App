    ...
    <section className="py-20">
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center mb-12">
          <p className="text-xs uppercase tracking-[0.2em] text-[#6bef9a] mb-3">Ecosystem</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
          {partners.map((p, i) => (
            <motion.div
              ...
              className="rounded-2xl p-6 border border-white/[0.06] bg-[#111] text-center hover:border-[#6bef9a]/20 transition-colors"
            >
              <div className="w-14 h-14 rounded-xl bg-[#6bef9a]/10 border border-[#6bef9a]/20 flex items-center justify-center mx-auto mb-4">
                <span className="font-heading text-[#6bef9a] text-lg">{p.name[0]}</span>
              </div>
